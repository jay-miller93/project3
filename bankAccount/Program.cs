    ...
    class Program
    {
        ...
        //    string person = viewInfo1.Name;
            ...
            if (input == 1)
            {
                ...
                Console.WriteLine("Client Name: {0}\nClient Address: {1}\nClient Age: {2}\nClient Soc.Sec.#: {3}", ViewInfo1.Name, ViewInfo1.Address, ViewInfo1.Age, ViewInfo1.SocialSecurity);
            }
            if(input == 2)
            {
            ...
            if (input == 3)
            {
                ...
                if (input2 == "b")
                {
                    savings1.DepositFunds(5.00M, 0M);
                }
